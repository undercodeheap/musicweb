    ...
    init: {
        tableInit: function () {
            $("#search_table").bootstrapTable({
                url: getRootPath() + "/queryCommentList", // 获取表格数据的url
                ...
                columns: [
                    ...
                    {
                        field: 'music.name', // 返回json数据中的name
                        title: '音乐', // 表格表头显示文字
                        align: 'center', // 左右居中
                        valign: 'middle'// 上下居中
                    },
                    {
                        ...
                        formatter: function (value, row, index) {
                            return '<button class="btn btn-primary btn-sm" onclick="deleteCommentList.event.deleteComment(' + row.id + ')">删除</button>';
                        }
                    }
                ],
