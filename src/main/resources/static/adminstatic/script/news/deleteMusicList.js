    ...
    init: {
        tableInit: function () {
            $("#search_table").bootstrapTable({
                url: getRootPath() + "/queryCheckedMusicList", // 获取表格数据的url
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        formatter: function (value, row, index) {
                            return '<button class="btn btn-primary btn-sm" onclick="deleteMusicList.event.deleteMusic(' + row.id + ')">删除</button>';
                        }
                    }
                ],
