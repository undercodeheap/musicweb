...
(function ($, window, document, undefined) {
    ...
    function _create_modal(config, ok, cancel) {
        ...
        $('#modal-tips-div').modal({backdrop: 'static', keyboard: false});
        ...
        // 重写弹出提示框的遮罩层 add by 朱明 20181022
        backdrop();
        return modal;
    }
    function backdrop() {
        var div = "<div class='myModals'></div>";
        $("body").append(div);
    }
    ...
    modals.ok = function() {
        var cfg = modal_params.apply(this, arguments);
        cfg.title = cfg.title||'成功';
        return _create_modal(cfg, true, false);
      // return _alert.call(this, arguments, 'correct');
    };
